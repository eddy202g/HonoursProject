...
{
    public class LessonThreeViewModel : INotifyPropertyChanged
    {
        ...
        #region Constructor
        public LessonThreeViewModel(int lessonValue)
        {
        ...
        private void PopulateElements(int lessonValue)
        {
            ...
            using (var reader = new System.IO.StreamReader(stream))
            {
                ...
                {
                    if (lessonValue == 3 && rootObject.lessonID == 3 && rootObject.pageID == 0)
                    {
                    ...
                    if (lessonValue == 3 && rootObject.lessonID == 3 && rootObject.pageID == 1)
                    {
                        ScreenTwoparaOne = rootObject.paraOne;
                        ScreenTwoparaTwo = rootObject.paraTwo;
                    }

                    if (lessonValue == 3 && rootObject.lessonID == 3 && rootObject.pageID == 3)
                    {
        ...
        public void UpdateDatabase()
        {
            using (var conn = new SQLiteConnection(App.DatabaseLocation))
            {
                ...
                var updateCurrentUser = conn.ExecuteScalar<RegisterModel>("UPDATE RegisterModel SET LessonThreeProgress = ? WHERE CurrentUser = ?", "true", "true");
