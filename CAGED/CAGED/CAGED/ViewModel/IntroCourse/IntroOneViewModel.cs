...
{
    public class IntroOneViewModel : INotifyPropertyChanged
    {
        ...
        private string introOneProgress = "false";
        public string IntroOneProgress
        {
            get
            {
        ...
        #region Constructor
        public IntroOneViewModel(int lessonValue)
        {
        ...
        private void PopulateElements(int lessonValue)
        {
            ...
            using (var reader = new System.IO.StreamReader(stream))
            {
                ...
                foreach (var rootObject in rootObjects)
                {
                    ...
                    if (lessonValue == 0 && rootObject.lessonID == 0 && rootObject.pageID == 0)
                    {
                    ...
                    if (lessonValue == 0 && rootObject.lessonID == 0 && rootObject.pageID == 1)
                    {
                        ScreenTwoparaOne = rootObject.paraOne;
                        ScreenTwoparaTwo = rootObject.paraTwo;                      
                    }

                    if (lessonValue == 0 && rootObject.lessonID == 0 && rootObject.pageID == 3)
                    {
        ...
        public void UpdateDatabase()
        {
            using (var conn = new SQLiteConnection(App.DatabaseLocation))
            {
                ...
                var updateCurrentUser = conn.ExecuteScalar<RegisterModel>("UPDATE RegisterModel SET IntroOneProgress = ? WHERE CurrentUser = ?", "true", "true");
