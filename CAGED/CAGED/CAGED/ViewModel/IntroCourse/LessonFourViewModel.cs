...
{
    public class LessonFourViewModel : INotifyPropertyChanged
    {
        ...
        #region Constructor
        public LessonFourViewModel(int lessonValue)
        {
        ...
        private void PopulateElements(int lessonValue)
        {
            ...
            using (var reader = new System.IO.StreamReader(stream))
            {
                ...
                {
                    if (lessonValue == 4 && rootObject.lessonID == 4 && rootObject.pageID == 0)
                    {
                    ...
                    if (lessonValue == 4 && rootObject.lessonID == 4 && rootObject.pageID == 1)
                    {
                        ScreenTwoparaOne = rootObject.paraOne;
                        ScreenTwoparaTwo = rootObject.paraTwo;
                    }

                    if (lessonValue == 4 && rootObject.lessonID == 4 && rootObject.pageID == 3)
                    {
        ...
        public void UpdateDatabase()
        {
            using (var conn = new SQLiteConnection(App.DatabaseLocation))
            {
                ...
                var updateCurrentUser = conn.ExecuteScalar<RegisterModel>("UPDATE RegisterModel SET LessonFourProgress = ? WHERE CurrentUser = ?", "true", "true");
